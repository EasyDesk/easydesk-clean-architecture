...
public class ErrorConverter : WriteOnlyJsonConverter<Error>
{
    ...
    private JsonSerializerSettings CloneSettingsFromSerializer(JsonSerializer serializer)
    {
        var serializerSettings = new JsonSerializerSettings
        {
            ...
            DeserializeError = serializer.DeserializeError,
            Deserializing = serializer.Deserializing,
            FloatPrecision = serializer.FloatPrecision,
            Serialized = serializer.Serialized,
            SerializeError = serializer.SerializeError,
            Serializing = serializer.Serializing,

...
public class AddAdminHandler : IHandler<AddAdmin>
{
    ...
    public AddAdminHandler(IIdentityRolesManager identityRolesManager, IAgentProvider agentProvider)
    {
    ...
    {
        await _identityRolesManager.GrantRoles(_agentProvider.RequireAgent().MainIdentity(), Roles.Admin);
        return Ok;
    }
}
